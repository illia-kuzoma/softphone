...
class ReportAgentStatusesGroup extends ReportAgentStatuses
{
        ...
        if ( ! empty( $data ) )
        {
            foreach ( $data as $item )
            {
                $result[] = [
                    ...
                    'duration' => self::calculateDuration($item)
                ];
            }
        }
    ...
    public static function calculateDuration(self $o_status)
    {
        $s_duration = '';
        ...
        return self::calculateDurationFromSeconds($i_duration);
    }
    public static function calculateDurationFromSeconds(int $i_duration)
    {
